...
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*Please wait downloading your video, It will take 2 - 10 min depending on the size of your videoᴏ...*`)
switch (command) {   
case "facebook3": case "fb3": case "facebookdl": case "fbdl":                                  
...
break
case "facebook": case "fb": case "facebookdl3": case "fbdl3":        
